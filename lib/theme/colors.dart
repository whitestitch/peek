...
const Color peekSecondaryColor = Color(0xFF03DAC6); // Teal
const Color peekBackgroundColor = Color(0xFF121212); // Dark background
...
const Color peekOnBackgroundColor = Colors.white;
const Color peekOnSurfaceColor = Colors.white;
const Color peekOnErrorColor = Colors.black;
