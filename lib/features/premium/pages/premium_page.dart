...
import '../controllers/subscription_controller.dart'; // Keep this
import '../providers/premium_controller.dart'; // Keep this

// *** ADD THIS DIRECT IMPORT ***
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed:
                  (isAlreadyPremium || isLoading || product == null)
